  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden transition-colors duration-300">
      ...
      <div 
        ...
        className="flex-1 bg-bg-card rounded-2xl border border-border-main p-6 font-mono text-[13px] overflow-y-auto scrollbar-thin shadow-inner"
      >
        <AnimatePresence mode="popLayout">
          {logs.map((log) => (
            ...
            >
              <span className="text-[10px] font-mono text-tertiary-dynamic shrink-0 mt-1">[{log.timestamp}]</span>
              ...
              <div className="flex-1 min-w-0">
                <span className={`font-bold inline-block mr-3 ${
                  ...
                  log.type === 'system' ? 'text-secondary-dynamic' :
                  log.type === 'error' ? 'text-red-400' : 'text-secondary-dynamic'
                }`}>
                  {log.agentName}
                </span>
                <p 
                  className="text-dynamic inline leading-relaxed"
