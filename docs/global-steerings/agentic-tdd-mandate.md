...
## HALTING CONDITION
Your implementation objective is EXCLUSIVELY to make the approved test bar green while satisfying all constraints from the spec. Do not over-engineer. Do not add features not in the spec.
...
- Removing test cases
- Modifying expected values to match your implementation
